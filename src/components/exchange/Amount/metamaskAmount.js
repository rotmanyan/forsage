...
const reducer = (state, action) => {
    switch (action.type) {
        ...
        case ACTIONS.SET_DIRTY: return { ...state, dirty: action.payload };
        case ACTIONS.SET_LOADING: return { ...state, isLoading: action.payload };
        case ACTIONS.NOTIFY_USER: return { ...state, transaction: action.payload, showPoUp: true };
        case ACTIONS.CLOSE_POPUP: return { ...state, showPoUp: false };
...
const Amount = ({
    ...
    const submitHandler = async (e) => {
        ...
        const { denied, transactionInfo, error } = await tokenService.buyTokens(amount)
